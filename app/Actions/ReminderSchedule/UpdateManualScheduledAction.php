...
final readonly class UpdateManualScheduledAction
{
    public function __construct(
        private CreateManualScheduledAction $createAction
    ) {}

    /**
     * Update manual reminder schedules by deleting old ones and creating new ones.
     *
