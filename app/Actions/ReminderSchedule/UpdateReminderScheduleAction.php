...
final readonly class UpdateReminderScheduleAction
{
    public function __construct(
        private CreateReminderScheduleAction $createAction
    ) {}

    /**
     * Update reminder schedules by deleting old ones and creating new ones.
     *
