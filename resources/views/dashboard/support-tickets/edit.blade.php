...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center my-4">
            <h5 class="fw-semibold mb-0">Edit Support Ticket</h5>
        </div>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <form action="{{ route('support-tickets.update', $ticket) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="invoice_id" class="form-select single-select2">
                                ...
                                @foreach ($invoices as $invoice)
                                    <option value="{{ $invoice->id }}" @selected(old('invoice_id', $ticket->invoice_id) == $invoice->id)>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-select single-select2" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="message" class="form-control" rows="6" required>{{ old('message', $ticket->message) }}</textarea>
                            @error('message')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($ticket->attachment_path)
                                <div class="mt-2">
                                    <span class="text-muted d-block mb-1">Current attachment:</span>
                    ...
                    <div class="mt-4 d-flex justify-content-end gap-2">
                        <a href="{{ route('support-tickets.show', $ticket) }}" class="btn btn-light">Cancel</a>
