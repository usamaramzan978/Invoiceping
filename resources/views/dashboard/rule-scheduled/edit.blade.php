...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <h1 class="page-title fw-semibold fs-18 mb-0">Edit Rule-Based Reminder</h1>
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Rule Scheduled</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('rule-scheduled.update', $schedule->id) }}" method="POST" id="reminderForm">
                            @csrf
                            @method('PUT')
                            <div class="row gy-4">
                                ...
                                <div class="col-12 text-end pt-3">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ri-check-line"></i> Update Rule
                                    </button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="card custom-card border-success">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning py-2 mb-0" style="font-size: 12px;">
                            <strong>Note:</strong> Updating will recreate all reminder schedules for the selected invoices based on the new rule and reference date.
                        </div>
                    </div>
                </div>
            </div>
