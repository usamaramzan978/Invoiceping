            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                ...
                <div class="card custom-card">
                    <div class="card-body p-5">
                        <p class="h5 fw-semibold mb-2 text-center">Confirm your password</p>
                        <p class="mb-4 text-muted op-7 fw-normal text-center">Please confirm your password before continuing.</p>

                        <form method="POST" action="{{ route('password.confirm') }}">
                            @csrf
                            <div class="row gy-3">
                                <div class="col-xl-12">
                                    <label for="confirm-password" class="form-label text-default">Password</label>
